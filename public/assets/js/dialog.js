		...
		return $($.parseHTML(
			`<div id="dialog" class="w-full h-full">
			   <div id="dialog-overlay" class="fixed top-0 start-0 w-full h-full"></div>
			     <div id="dialog-body" class="bg-white text-gray-600 rounded-xl dark:bg-gray-900 dark:text-white border border-gray-300 dark:border-gray-800 text-center relative px-8 py-2 top-0 start-0 end-0 bottom-0 mx-auto h-36 mt-32 block w-72 animate__animated">
				     <p id="dialog-message" class="pt-6 pb-3">${message}</p>
